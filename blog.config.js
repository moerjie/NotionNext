...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '13d96f31fcb98008bff5f50f983fd6d6',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SawenMoerjie', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的传媒工科牲', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'blog.sawenmoerjie.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'sawenmoerjie.outlook.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://x.com/@sawenmoerjie', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/moerjie', // 你的github个人主页 例如 https://
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon_notion.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png

  IMAGE_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMAGE_COMPRESS_WIDTH || 800, // 图片压缩宽度默认值，作用于博客封面和文章内容 越小加载图片越快
  IMAGE_ZOOM_IN_WIDTH: process.env.NEXT_PUBLIC_IMAGE_ZOOM_IN_WIDTH || 1600, // 文章图片点击放大后的画质宽度，不代表在网页中的实际展示宽度
  ...
  POSTS_PER_PAGE: process.env.NEXT_PUBLIC_POST_PER_PAGE || 15, // post counts per page
  POSTS_SORT_BY: process.env.NEXT_PUBLIC_POST_SORT_BY || 'data', // 排序方式 'date'按时间,'notion'由notion控制
